...
public class BluetoothService {
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    arr_byte.add(mmInStream.read());

                    if (    //STATUS
                            (arr_byte.size() == 16 && arr_byte.get(0).byteValue() == 83
                                    && arr_byte.get(1).byteValue() == 84
                                    && arr_byte.get(2).byteValue() == 65
                                    && arr_byte.get(3).byteValue() == 84
                                    && arr_byte.get(4).byteValue() == 85
                                    && arr_byte.get(5).byteValue() == 83) ||
                                    //RESULT
                                    (arr_byte.size() == 512 && arr_byte.get(0).byteValue() == 82
